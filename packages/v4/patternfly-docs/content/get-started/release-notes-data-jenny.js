...
export const releaseNotes = [
  ...
  },
  {
    ...
    description: (
      <>
        Updated callback props to include the <code class="ws-code">event</code>{" "}
    ...
    details: (
      <TextContent>
        <Text component={TextVariants.p}>
          The <code class="ws-code">onChangeUsername</code>,{" "}
          <code class="ws-code">onChangePassword</code>, and{" "}
          <code class="ws-code">onChangeRememberMe</code> props now take{" "}
          <code class="ws-code">event</code> as the first parameter. Selectors
...
<LoginPage backgroundImgSrc={srcPath} />`}</CodeBlockCode>
  ...
  },
  {
    ...
    description: (
      <>
        We've updated <code className="ws-code">MastheadBrand</code> to only be
        an anchor if an
...
<MastheadBrand component="div" />`}</CodeBlockCode>
  ...
  },
  {
    ...
    description: (
      <>
        We've removed the <code className="ws-code">aria-label</code> prop on
...
`}
  ...
  },
  {
    ...
    description: (
      <>
        Updated the <code class="ws-code">aria-label</code> prop on
  ...
  },
  {
    ...
    description: (
      <>
        Updated the <code class="ws-code">onFileDrop</code> prop for
        MultipleFileUpload so that the <code class="ws-code">event</code>{" "}
...
<MultipleFileUpload onFileDrop={handler2} />`}
  ...
  },
  {
    ...
    description: (
      <>
        Updated the <code class="ws-code">onSelect</code> and{" "}
        <code class="ws-code">onToggle</code> props for Nav so that the{" "}
        <code class="ws-code">event</code> parameter is the first parameter, and
        have removed the event property from the{" "}
        <code class="ws-code">selectedItem</code> and{" "}
        <code class="ws-code">toggledItem</code> object parameters respectively.
      </>
    ),
...
<Navigation onToggle={toggleHandler2} />`}</CodeBlockCode>
  ...
  },
  {
    ...
    description: (
      <>
        We've removed the <code class="ws-code">isRead</code> prop from
        NotificationBadge, use "read" or "unread" on the{" "}
        <code class="ws-code">variant</code> prop instead.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        We've removed the <code class="ws-code">allowEmptyInput</code> prop from
        NumberInput.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        {" "}
        We've updated the <code class="ws-code">onToggle</code> function to
        include the <code class="ws-code">event</code> as its first parameter
        for the following components:{" "}
        <code class="ws-code">ApplicationLauncher</code>,{" "}
        <code class="ws-code">BadgeToggle</code>,{" "}
        <code class="ws-code">DropdownToggle</code>,{" "}
        <code class="ws-code">KebabToggle</code>,{" "}
        <code class="ws-code">Toggle</code>, <code class="ws-code">Select</code>
        , and <code class="ws-code">SelectToggle</code>.
      </>
    ),
...
<DropdownToggle onToggle={toggleDropdown}>>`}
  ...
  },
  {
    ...
    description: (
      <>
        Deprecated <code class="ws-code">OptionsMenu</code> components.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        Renamed the <code class="ws-code">index</code> prop for
        OverflowMenuDropdownItem to <code class="ws-code">itemId</code>, and
        updated its type to <code class="ws-code">string | number</code>.
      </>
    ),
    pullRequestURL: "https://github.com/patternfly/patternfly-react/pull/8359",
    details: (
...
<PageToggleButton isNavOpen={true} onNavToggle={() => {}} />`}
  ...
  },
  {
    ...
    description: (
      <>
        Updated <code class="ws-code">onPageResize</code> prop so that the{" "}
        <code class="ws-code">event</code> parameter is the first parameter.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        Deprecated the <code class="ws-code">PageHeader</code> components.
      </>
    ),
...
import {
  ...
  },
  {
    ...
    description: (
      <>
        Updated <code class="ws-code">PageHeader</code>'s logo to only be an
        anchor if an <code class="ws-code">href</code> is specified.
      </>
    ),
    pullRequestURL: "https://github.com/patternfly/patternfly-react/pull/8655",
    details: (
...
<PageHeader logoComponent="div" />`}
  ...
  },
  {
    ...
    description: (
      <>
        API has been updated. The <code class="ws-code">nav</code> prop has been
        renamed to <code class="ws-code">children</code>. Any content passed to
  ...
  },
  {
    ...
    description: (
      <>
        Removed the <code class="ws-code">OptionsToggle</code> used by{" "}
        <code class="ws-code">Pagination</code> and replaced it with{" "}
        <code class="ws-code">Menu</code> and{" "}
        <code class="ws-code">MenuToggle</code>.
      </>
    ),
